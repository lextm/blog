...
Starting from [HTTP Bridge Module for IIS]({% post_url 2024/2024-4-8-httpplatformhandler-v2 %}), you can specify a fixed port easily. Just update your `web.config` like this:
