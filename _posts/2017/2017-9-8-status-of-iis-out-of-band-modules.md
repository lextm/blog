...
| URL Rewrite module | * Microsoft installer: You can only use it with x86/x64 application pools. ARM64 application pools will crash. <br>* Possible to resolve this by [extracting the right bits from IIS Express ARM64](https://github.com/lextm/rewrite-arm64). |
